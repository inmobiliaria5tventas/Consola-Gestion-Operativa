...
# Replace the gerente chart rendering block
gerente_old = \"\"\"          if (role === 'gerente') {
...
# Now we need to inject the 6 new functions right above renderDashboard
# Let's find 'function renderDashboard(role) {'
funcs = \"\"\"
      // --- NEW GERENCIA CHARTS ---
